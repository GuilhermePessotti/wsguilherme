...
public class DecisaoSimplesDesafio {
	...
	public static void main(String[] args) {
		...
		if (idade >= 18 && idade < 70) {
			System.out.println("Olá " + nome + " voce é obrigado a votar pois !");
		}
		
		if (idade >= 16 && idade < 18 || idade >= 70) {
			System.out.println("Olá " + nome + " seu voto é facultativo !");
		}
		
		if(idade < 16) {
			System.out.println("Olá " + nome + " voce não pode votar !");
		}
