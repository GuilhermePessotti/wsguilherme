...
public class Exercicio3 {
	...
	public static void main(String[] args) {
		/*
		 * Exercicio 3 Solicite ao usuário (enquanto ele quiser), o cargo e o salario do
		 * cargo. No final exiba: - total de todos os salarios - média - o maior valor
		 * entre todos os salários que foram digitados, com o cargo.
		 * 
		 * 
		 */
		String cargo = "";
